...
const techFeatures = [
  ...
  },
  {
    ...
    desc: "Downloaded agents work immediately with the gitclaw SDK and clawless serverless runtime — no post-processing required.",
    tags: ["Runtime", "Deploy"],
    detail: [
      "`npx gitagent validate` passes out of the box",
      "Install with `npm install gitclaw` to run via SDK",
      "Deploy serverlessly with `npm install clawless`",
